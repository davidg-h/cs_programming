...
namespace FittsExercise
{
    ...
    public partial class MainWindow : Window
    {
        ...
        public MainWindow()
        {
            ...
            Setup s = new Setup();
            s.ShowDialog();
            if (s.updateSettings == true)
            {
                experimentId = Int32.Parse(s.IDLabel.Text);
                nbrOfTasks = Int32.Parse(s.NumberTaskLabel.Text);
                resetMousePos = (bool)s.ResetMouse.IsChecked;
                precuing = (bool)s.Precuing.IsChecked;
            }
        ...
        protected void EndExperiment()
        {
            ...
            MessageBox.Show($"Errors: {sessionErrorCount}", "Errors in one sessions", MessageBoxButton.OK);
            ...
            dlg.DefaultExt = fileNameExt;
            dlg.Filter = "Excel tabel (.csv)|*.csv";
            dlg.InitialDirectory = @"E:\1.Schule TH Synchro\Min Semester 3\Int.Systeme\AB5 (Fitts)\Test Files";
